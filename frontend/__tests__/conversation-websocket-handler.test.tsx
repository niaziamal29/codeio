...
describe("Conversation WebSocket Handler", () => {
  ...
  describe("Message Sending", () => {
    ...
    it("should not throw error when sendMessage is called (queues message internally)", async () => {
      // This test verifies that sendMessage doesn't throw an error
      // when the WebSocket is connected - the implementation queues messages
      // when disconnected and sends immediately when connected.
