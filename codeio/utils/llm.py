...
from codeio.llm import bedrock

# Hardcoded Codeio provider models used in self-hosted mode.
# In SaaS mode these are loaded from the database instead.
OPENHANDS_MODELS = [
    'codeio/claude-opus-4-6',
    'codeio/claude-opus-4-5-20251101',
    'codeio/claude-sonnet-4-6',
    'codeio/claude-sonnet-4-5-20250929',
    'codeio/gpt-5.2-codex',
    'codeio/gpt-5.2',
    'codeio/minimax-m2.5',
    'codeio/gemini-3-pro-preview',
    'codeio/gemini-3.1-pro-preview',
    'codeio/gemini-3-flash-preview',
    'codeio/deepseek-chat',
    'codeio/devstral-medium-2512',
    'codeio/kimi-k2-0711-preview',
    'codeio/kimi-k2.5',
    'codeio/qwen3-coder-480b',
    'codeio/qwen3-coder-next',
    'codeio/glm-4.7',
    'codeio/glm-5',
]
...
def is_openhands_model(model: str | None) -> bool:
    """Check if the model uses the Codeio provider.

    Args:
        model: The model name to check.

    Returns:
        True if the model starts with 'codeio/', False otherwise.
    """
    return bool(model and model.startswith('codeio/'))
...
def get_supported_llm_models(
    ...
    Args:
        config: The Codeio configuration.
