...
from codeio.core.config.config_utils import (
...
class CodeioConfig(BaseModel):
    ...
    Attributes:
        ...
        mcp_host: Host for Codeio' default MCP server
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        if not CodeioConfig.defaults_dict:  # Only set defaults_dict if it's empty
            CodeioConfig.defaults_dict = model_defaults_to_dict(self)
