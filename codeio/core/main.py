...
from codeio.core.config.mcp_config import CodeioMCPConfigImpl
from codeio.core.logger import openhands_logger as logger
from codeio.core.loop import run_agent_until_done
from codeio.core.schema import AgentState
from codeio.core.setup import (
    create_agent,
    create_controller,
    create_memory,
    create_runtime,
...
from codeio.events import EventSource, EventStreamSubscriber
from codeio.events.action import MessageAction, NullAction
from codeio.events.action.action import Action
from codeio.events.event import Event
from codeio.events.observation import AgentStateChangedObservation
from codeio.io import read_input, read_task
...
async def run_controller(
    ...
    if agent.config.enable_mcp:
        # Add Codeio' MCP server by default
        (
            _,
            openhands_mcp_stdio_servers,
        ) = await CodeioMCPConfigImpl.create_default_mcp_server_config(
...
if __name__ == '__main__':
    ...
    config: CodeioConfig = setup_config_from_args(args)
