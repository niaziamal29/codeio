...
from codeio.core.config import AgentConfig, CodeioConfig, SandboxConfig
from codeio.core.config.utils import load_openhands_config
from codeio.core.logger import openhands_logger as logger
from codeio.core.main import create_runtime, run_controller
...
from codeio.resolver.utils import (
...
class IssueResolver:
    ...
    def update_sandbox_config(
        ...
        if (
            ...
            runtime_container_image = (
                f'ghcr.io/codeio/runtime:{openhands.__version__}-nikolaik'
            )
    ...
    def initialize_runtime(
        ...
        logger.info('Checking for .codeio/setup.sh script...')
        runtime.maybe_run_setup_script()

        # Setup git hooks if they exist
        logger.info('Checking for .codeio/pre-commit.sh script...')
