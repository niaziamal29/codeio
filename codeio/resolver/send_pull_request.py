...
from codeio.resolver.interfaces.bitbucket_data_center import BitbucketDCIssueHandler
from codeio.resolver.interfaces.forgejo import ForgejoIssueHandler
...
from codeio.resolver.io_utils import (
    load_single_resolver_output,
)
from codeio.resolver.patching import apply_diff, parse_patch
from codeio.resolver.resolver_output import ResolverOutput
from codeio.resolver.utils import identify_token
...
PR_SIGNATURE = (
    'Automatic fix generated by [Codeio](https://github.com/Codeio/Codeio/) 🙌'
)
...
def update_existing_pull_request(
    ...
    if not comment_message and additional_message:
        try:
            ...
            if explanations:
                comment_message = (
                    'Codeio made the following changes to resolve the issues:\n\n'
                )
            ...
            comment_message = (
                'A new Codeio update is available, but failed to parse or summarize '
                f'the changes:\n{additional_message}'
            )
