...
from codeio.events.action.agent import AgentFinishAction
...
from codeio.storage.locations import get_conversation_agent_state_filename
...
@dataclass
class State:
    """Represents the running state of an agent in the Codeio system, saving data of its operation and memory.
