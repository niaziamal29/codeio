"""Utility functions for LLM metadata in Codeio V1 conversations."""
...
def should_set_litellm_extra_body(model_name: str) -> bool:
    ...
    The SDK internally translates "codeio/" prefix to "litellm_proxy/"
    ...
    """
    return 'codeio/' in model_name or 'litellm_proxy/' in model_name
...
def get_llm_metadata(
    ...
    """Generate LLM metadata for Codeio V1 conversations.
