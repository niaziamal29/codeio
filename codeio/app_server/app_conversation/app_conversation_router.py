"""Sandboxed Conversation router for Codeio App Server."""
...
from codeio.app_server.services.db_session_injector import set_db_session_keep_open
from codeio.app_server.services.httpx_client_injector import (
    set_httpx_client_keep_open,
)
from codeio.app_server.services.injector import InjectorState
from codeio.app_server.user.specifiy_user_context import USER_CONTEXT_ATTR
from codeio.app_server.user.user_context import UserContext
from codeio.server.dependencies import get_dependencies
...
from codeio.sdk.context.skills import KeywordTrigger, TaskTrigger
...
async def get_conversation_skills(
    ...
    - Global skills (Codeio/skills/)
    - User skills (~/.codeio/skills/)
    - Organization skills (org/.openhands repository)
    - Repository skills (repo/.codeio/skills/ or .codeio/microagents/)
    ...
    try:
        ...
        if not sandbox_spec:
            ...
            # sandbox spec versions when updating Codeio. When the SandboxSpecServices
