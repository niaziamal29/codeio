...
from codeio.sdk.utils.models import (
...
class CreateEventCallbackRequest(CodeioModel):
    conversation_id: CodeioUUID | None = Field(
        default=None,
        description=(
...
class EventCallbackPage(CodeioModel):
