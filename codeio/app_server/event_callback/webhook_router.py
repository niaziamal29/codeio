"""Event Callback router for Codeio App Server."""
...
from codeio.app_server.user.auth_user_context import AuthUserContext
...
from codeio.sdk import ConversationExecutionStatus, Event
from codeio.sdk.event import ConversationStateUpdateEvent
from codeio.server.types import AppMode
from codeio.server.user_auth.default_user_auth import DefaultUserAuth
from codeio.server.user_auth.user_auth import (
...
async def get_secret(
    ...
    try:
        ...
        if user_id:
            ...
            # Codeio (OSS mode) - use default user auth
