...
from codeio.sdk.secret import SecretSource, StaticSecret
from codeio.server.user_auth.user_auth import UserAuth, get_user_auth
...
class AuthUserContext(UserContext):
    ...
    async def get_user_id(self) -> str | None:
        ...
        # it means we are in Codeio (OSS mode).
