...
from codeio.integrations.bitbucket.service import (
...
class BitBucketService(
    ...
    This is an extension point in Codeio that allows applications to customize Bitbucket
...
bitbucket_service_cls = os.environ.get(
    ...
    'codeio.integrations.bitbucket.bitbucket_service.BitBucketService',
)
