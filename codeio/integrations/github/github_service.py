...
from codeio.integrations.github.service import (
    GitHubBranchesMixin,
    GitHubFeaturesMixin,
    GitHubPRsMixin,
    GitHubReposMixin,
...
class GitHubService(
    ...
    This is an extension point in Codeio that allows applications to customize GitHub
...
github_service_cls = os.environ.get(
    ...
    'codeio.integrations.github.github_service.GitHubService',
)
