...
from codeio.integrations.bitbucket_data_center.service import (
...
class BitbucketDCService(
    ...
    This is an extension point in Codeio that allows applications to customize Bitbucket data center
...
bitbucket_dc_service_cls = os.environ.get(
    ...
    'codeio.integrations.bitbucket_data_center.bitbucket_dc_service.BitbucketDCService',
)
