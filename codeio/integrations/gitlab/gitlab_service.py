...
from codeio.integrations.gitlab.service import (
    GitLabBranchesMixin,
    GitLabFeaturesMixin,
    GitLabPRsMixin,
    GitLabReposMixin,
...
class GitLabService(
    ...
    This is an extension point in Codeio that allows applications to customize GitLab
...
gitlab_service_cls = os.environ.get(
    ...
    'codeio.integrations.gitlab.gitlab_service.GitLabService',
)
