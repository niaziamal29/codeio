...
from codeio.integrations.azure_devops.service.base import AzureDevOpsMixinBase
from codeio.integrations.service_types import Comment, RequestMethod
...
class AzureDevOpsWorkItemsMixin(AzureDevOpsMixinBase):
    ...
    async def add_work_item_reaction(
        ...
        comment_text = f'{reaction_type} Codeio is processing this work item...'
