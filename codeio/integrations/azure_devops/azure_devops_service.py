...
from codeio.integrations.azure_devops.service.branches import (
    AzureDevOpsBranchesMixin,
)
from codeio.integrations.azure_devops.service.features import (
    AzureDevOpsFeaturesMixin,
)
from codeio.integrations.azure_devops.service.prs import AzureDevOpsPRsMixin
from codeio.integrations.azure_devops.service.repos import AzureDevOpsReposMixin
from codeio.integrations.azure_devops.service.resolver import (
    AzureDevOpsResolverMixin,
)
from codeio.integrations.azure_devops.service.work_items import (
    AzureDevOpsWorkItemsMixin,
)
from codeio.integrations.protocols.http_client import HTTPClient
...
class AzureDevOpsService(
    ...
    This is an extension point in Codeio that allows applications to customize Azure DevOps
...
azure_devops_service_cls = os.environ.get(
    ...
    'codeio.integrations.azure_devops.azure_devops_service.AzureDevOpsService',
)
