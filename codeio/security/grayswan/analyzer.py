...
# Tag: Legacy-V0
"""GraySwan security analyzer for Codeio."""
...
from codeio.events.action.action import Action, ActionSecurityRisk
from codeio.events.event_store_abc import EventStoreABC
from codeio.memory.view import View
from codeio.security.analyzer import SecurityAnalyzer
from codeio.security.grayswan.utils import convert_events_to_openai_messages
...
class GraySwanAnalyzer(SecurityAnalyzer):
    ...
    def _map_violation_to_risk(self, violation_score: float) -> ActionSecurityRisk:
        """Map GraySwan violation score to Codeio ActionSecurityRisk."""
