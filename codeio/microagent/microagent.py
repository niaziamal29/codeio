...
from codeio.microagent.types import InputMetadata, MicroagentMetadata, MicroagentType
...
class RepoMicroagent(BaseMicroagent):
    ...
    RepoMicroagents are loaded from `.codeio/microagents/repo.md` files within repositories
...
def load_microagents_from_dir(
    ...
    Args:
        microagent_dir: Path to the microagents directory (e.g. .codeio/microagents)
