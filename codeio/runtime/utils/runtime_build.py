...
import openhands
from codeio.core.exceptions import AgentRuntimeBuildError
from codeio.core.logger import openhands_logger as logger
from codeio.runtime.builder import DockerRuntimeBuilder, RuntimeBuilder
...
def get_runtime_image_repo() -> str:
    return os.getenv('OH_RUNTIME_RUNTIME_IMAGE_REPO', 'ghcr.io/codeio/runtime')
...
def build_runtime_image(
    ...
    If dry_run is False, it will also build the Codeio runtime Docker image using the docker build folder.
