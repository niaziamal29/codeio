...
from codeio.runtime.utils import git_changes, git_diff

GIT_CHANGES_CMD = 'python3 /codeio/code/codeio/runtime/utils/git_changes.py'
GIT_DIFF_CMD = 'python3 /codeio/code/codeio/runtime/utils/git_diff.py {file_path}'
