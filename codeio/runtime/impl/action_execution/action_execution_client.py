...
from codeio.events.action.files import FileEditSource
...
from codeio.runtime.utils.request import send_request
from codeio.runtime.utils.system_stats import update_last_execution_time
from codeio.utils.http_session import HttpSession
...
class ActionExecutionClient(Runtime):
    ...
    async def call_tool_mcp(self, action: MCPAction) -> Observation:
        ...
        from codeio.mcp.utils import call_tool_mcp as call_tool_mcp_handler
        from codeio.mcp.utils import create_mcp_clients
