...
if sys.platform == 'win32':
    try:
        from codeio.runtime.utils.windows_exceptions import DotNetMissingError
        from codeio.runtime.utils.windows_bash import WindowsPowershellSession  # isort: skip
...
The .NET SDK and PowerShell are required for Codeio CLI on Windows.
