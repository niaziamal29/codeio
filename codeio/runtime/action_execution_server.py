...
It is responsible for executing actions received from Codeio backend and producing observations.
...
from codeio.core.config.mcp_config import MCPStdioServerConfig
from codeio.core.exceptions import BrowserUnavailableException
from codeio.core.logger import get_uvicorn_json_log_config
...
from codeio.events.serialization import event_from_dict, event_to_dict
from codeio.runtime.browser import browse
from codeio.runtime.browser.browser_env import BrowserEnv
from codeio.runtime.file_viewer_server import start_file_viewer_server

# Import our custom MCP Proxy Manager
from codeio.runtime.mcp.proxy import MCPProxyManager
from codeio.runtime.plugins import ALL_PLUGINS, JupyterPlugin, Plugin, VSCodePlugin
from codeio.runtime.utils import find_available_tcp_port
from codeio.runtime.utils.bash import BashSession
from codeio.runtime.utils.files import insert_lines, read_lines
from codeio.runtime.utils.memory_monitor import MemoryMonitor
from codeio.runtime.utils.runtime_init import init_user_and_working_directory
from codeio.runtime.utils.system_stats import (
    get_system_stats,
    update_last_execution_time,
)
from codeio.utils.async_utils import call_sync_from_async, wait_all

if sys.platform == 'win32':
    from codeio.runtime.utils.windows_bash import WindowsPowershellSession
    ...
    async def ainit(self):
        ...
        if 'agent_skills' in self.plugins and 'jupyter' in self.plugins:
            obs = await self.run_ipython(
                IPythonRunCellAction(
                    code='from codeio.runtime.plugins.agent_skills.agentskills import *\n'
                )
            )
