...
from codeio.core.exceptions import LLMResponseError
from codeio.events.event import Event
from codeio.events.observation import CmdOutputMetadata
from codeio.events.serialization import event_to_dict
from codeio.llm.metrics import Metrics


class CodeioJSONEncoder(json.JSONEncoder):
...
_json_encoder = CodeioJSONEncoder()
...
def dumps(obj, **kwargs) -> str:
    ...
    if 'cls' not in encoder_kwargs:
        encoder_kwargs['cls'] = CodeioJSONEncoder
