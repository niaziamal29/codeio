...
from codeio.storage.data_models.conversation_metadata_result_set import (
...
from codeio.utils.search_utils import offset_to_page_id, page_id_to_offset
...
class FileConversationStore(ConversationStore):
    ...
    async def get_instance(
        cls, config: CodeioConfig, user_id: str | None
