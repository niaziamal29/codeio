...
class ConversationManager(ABC):
    """Abstract base class for managing conversations in Codeio.
    ...
    This is an extension point in Codeio, that applications built on it can use to modify behavior via server configuration, without modifying its code.
