...
from codeio.server.types import AppMode, ServerConfigInterface
...
class ServerConfig(ServerConfigInterface):
    ...
    settings_store_class: str = (
        'codeio.storage.settings.file_settings_store.FileSettingsStore'
    )
    secret_store_class: str = (
        'codeio.storage.secrets.file_secrets_store.FileSecretsStore'
    )
    conversation_store_class: str = (
        'codeio.storage.conversation.file_conversation_store.FileConversationStore'
    )
    ...
    monitoring_listener_class: str = 'codeio.server.monitoring.MonitoringListener'
    user_auth_class: str = (
        'codeio.server.user_auth.default_user_auth.DefaultUserAuth'
    )
