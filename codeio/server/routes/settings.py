...
from codeio.server.routes.secrets import invalidate_legacy_secrets_store
from codeio.server.settings import (
    GETSettingsModel,
)
from codeio.server.shared import config
    ...
    if existing_settings:
        ...
        if not settings.llm_base_url:
            if settings.llm_base_url is None and existing_settings.llm_base_url:
                ...
                # Codeio models use the LiteLLM proxy
