...
from codeio.events.event_store import EventStore
...
from codeio.runtime import get_runtime_cls
...
from codeio.server.shared import (
...
from codeio.server.utils import get_conversation as get_conversation_metadata
from codeio.server.utils import get_conversation_store, validate_conversation_id
...
from codeio.utils.async_utils import wait_all
from codeio.utils.conversation_summary import get_default_conversation_title
from codeio.utils.environment import get_effective_llm_base_url
...
def generate_prompt_template(events: str) -> str:
    env = Environment(loader=FileSystemLoader('codeio/microagent/prompts'))
