...
from codeio.microagent.types import (
...
async def get_repository_microagents(
    ...
    - Otherwise: scans ".codeio/microagents" folder
...
async def get_repository_microagent_content(
    ...
    Example:
        GET /api/user/repository/owner/repo/microagents/content?file_path=.codeio/microagents/my-agent.md
    """
    try:
        # Create provider handler for API authentication
        provider_handler = ProviderHandler(
