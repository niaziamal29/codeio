...
from codeio.events.stream import EventStream, EventStreamSubscriber
...
class Memory:
    ...
    def __init__(
        ...
        # from typically Codeio/skills (i.e., the PUBLIC microagents)
        self._load_global_microagents()

        # Load user microagents from ~/.codeio/microagents/
    ...
    def _load_user_microagents(self) -> None:
        """Loads microagents from the user's home directory (~/.codeio/microagents/)
