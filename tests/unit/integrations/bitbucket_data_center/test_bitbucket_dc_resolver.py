...
from codeio.integrations.service_types import Comment
...
def test_mro_includes_resolver_mixin_and_base_git_service():
    from codeio.integrations.bitbucket_data_center.service.resolver import (
        BitbucketDCResolverMixin,
    )
    from codeio.integrations.service_types import BaseGitService
