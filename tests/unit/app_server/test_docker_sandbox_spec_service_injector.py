...
from codeio.app_server.sandbox.preset_sandbox_spec_service import (
...
class TestDockerSandboxSpecServiceInjector:
    ...
    @patch('codeio.app_server.sandbox.docker_sandbox_spec_service.get_docker_client')
    ...
    def test_get_default_sandbox_specs(self):
        ...
        assert specs[0].id.startswith('ghcr.io/codeio/agent-server:')
    ...
    @patch(
        'codeio.app_server.sandbox.docker_sandbox_spec_service._global_docker_client',
        None,
    )
    ...
    def test_get_docker_client_reuses_existing_client(
        ...
        import codeio.app_server.sandbox.docker_sandbox_spec_service as module
    ...
    @patch('codeio.app_server.sandbox.docker_sandbox_spec_service.get_docker_client')
    @patch('codeio.app_server.sandbox.docker_sandbox_spec_service._logger')
