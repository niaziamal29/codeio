...
from codeio.resolver.issue_resolver import (
    IssueResolver,
)
...
async def test_process_issue(
    ...
    with (
        ...
        patch(
            'codeio.resolver.issue_resolver.SandboxConfig', return_value=MagicMock()
        ),
        patch(
            'codeio.resolver.issue_resolver.CodeioConfig',
